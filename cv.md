...
<section class="panel cv-header">
  ...
  <div class="cv-contact">
    ...
    <p>Spain</p>
    <p><a href="https://github.com/sbartaula">GitHub</a> · <a href="https://sbartaula.github.io">Website</a></p>
  </div>
</section>
...
<section class="cv-grid">
  <article class="panel cv-card">
    ...
    <ul class="clean-list">
      <li>Turning prototypes into useful product systems</li>
      <li>Building computer vision and pose-based pipelines</li>
      <li>Designing APIs and backend workflows</li>
      <li>Writing technical notes and documenting experiments</li>
    </ul>
  </article>
  ...
  <article class="panel cv-card">
    ...
    <ul class="clean-list">
      ...
      <li>edX / online AI and software engineering courses</li>
    </ul>
    ...
    <h3>Interests</h3>
    <p>AI, computer vision, robotics, digital twins, sports technology, science, space, books, films</p>
  </article>
</section>
